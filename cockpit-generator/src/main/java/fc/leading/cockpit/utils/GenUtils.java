...
package fc.leading.cockpit.utils;

import fc.leading.cockpit.entity.ColumnEntity;
import fc.leading.cockpit.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "fc.leading.cockpit" : mainPath;
